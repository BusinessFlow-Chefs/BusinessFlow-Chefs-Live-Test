const CACHE='businessflow-shell-v1';
const SHELL=['./','./index.html','./bf-core.js','./bf-platform.js','./service-sequence.html','./chef-mode.html','./style.css','./assets/home-master.webp'];
