const CACHE='businessflow-shell-v6';
const SHELL=['./','./index.html','./bf-core.js','./bf-platform.js','./bf-theme.css','./bf-menu.js','./bf-menu-themes.js','./bf-recipes.js','./bf-stock.js','./bf-sourcing.js','./charter.html','./guests.html','./menu-builder.html','./dish-details.html','./inventory.html','./provisioning.html','./journey.html','./sourcing.html','./suppliers.html','./service-sequence.html','./chef-mode.html','./style.css','./assets/home-master.webp'];
